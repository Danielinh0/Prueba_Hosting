            ...
            <form action="{{ route('admin.proyectos-evento.update', $proyectoEvento) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @if($proyectoEvento->archivo_bases)
                        <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                            <p class="text-sm text-green-700">
                                ✓ Archivo actual: <strong>{{ basename($proyectoEvento->archivo_bases) }}</strong>
                            </p>
                            <p class="text-xs text-green-600 mt-1">Sube un nuevo archivo si deseas reemplazarlo</p>
                        </div>
                    @endif
                ...
                <div class="mb-6">
                    ...
                    @if($proyectoEvento->archivo_recursos)
                        <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                            <p class="text-sm text-green-700">
                                ✓ Archivo actual: <strong>{{ basename($proyectoEvento->archivo_recursos) }}</strong>
                            </p>
                            <p class="text-xs text-green-600 mt-1">Sube un nuevo archivo si deseas reemplazarlo</p>
                        </div>
                    @endif
